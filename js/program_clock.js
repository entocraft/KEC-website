var hoursHand = document.getElementById('TAGhoursHand'),
  minutesHand = document.getElementById('TAGminutesHand'),
  secondsHand = document.getElementById('TAGsecondsHand'),
  date,
  hours,
  minutes,
  seconds;
